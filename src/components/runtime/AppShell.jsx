...
export default function AppShell() {
  ...
  return <div className="min-h-screen bg-[#07111f] text-slate-100">
    <header className="h-16 border-b border-white/10 bg-[#0a1728] px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2"><NotificationCenter/><button onClick={() => base44.auth.logout('/login')} className="flex items-center gap-2 text-sm text-slate-400 hover:text-white transition-colors"><LogOut size={16}/> Sign out</button></div>
    </header>
