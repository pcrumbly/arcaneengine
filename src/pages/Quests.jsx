...
export default function Quests() {
  ...
  return <div className="p-4 sm:p-6"><PageHeader eyebrow="Character / Journal" title="Quests & objectives" description="Track available work, active objectives, decisions, rewards, and completed outcomes."/>{error && <div role="alert" className="mt-4 rounded-md border border-red-400/20 bg-red-400/10 p-3 text-sm text-red-200">{error}</div>}
