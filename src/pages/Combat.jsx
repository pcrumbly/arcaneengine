...
export default function Combat() {
  ...
  return <div className="p-4 sm:p-6"><PageHeader eyebrow="Runtime / Tactical resolution" title="Combat" description="Server-resolved actions with deterministic replay data." actions={combatStatus}/>{error && <div role="alert" className="mt-4 rounded-md border border-red-400/20 bg-red-400/10 p-3 text-sm text-red-200">{error}</div>}
