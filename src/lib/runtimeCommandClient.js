...
const readCommands = new Set(['GET_STATE','GET_INVENTORY','GET_QUESTS','GET_OPERATIONS','GET_NOTIFICATIONS','GET_COMBAT','GET_PARTY','GET_SETTINGS','GET_SKILLS','GET_WORLD','GET_JOURNAL','GET_PRESENTATION','GET_ACCOUNT','GET_RUNTIME_MODULE','GET_NPC_INTERACTION','GET_CHARACTER_PROFILE','STUDIO_OVERVIEW','GET_STUDIO_CONTENT','GET_CONTENT_SCHEMA_REGISTRY','GET_CONTENT_DEPENDENCIES','EXPORT_CONTENT_PACKS','PREVIEW_BULK_STUDIO_CONTENT','GET_SIMULATION','GET_ADMIN_USERS','GET_ACHIEVEMENTS','GET_CONTEXTUAL_ACTIONS']);
