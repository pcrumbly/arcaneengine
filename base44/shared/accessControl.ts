const adminCommands=new Set([
  ...
  'CREATE_GAME','SAVE_GAME_CONFIG','CREATE_CONTENT_PACK','EXPORT_CONTENT_PACKS','IMPORT_CONTENT_PACKS','GET_CONTENT_SCHEMA_REGISTRY','GET_CONTENT_DEPENDENCIES','REBUILD_CONTENT_DEPENDENCY_INDEX','GET_STUDIO_CONTENT','PREVIEW_BULK_STUDIO_CONTENT','IMPORT_BULK_STUDIO_CONTENT','SAVE_STUDIO_CONTENT','DELETE_STUDIO_CONTENT',
